...
// additional feature added: ability to restart the game from the beginning, clearing console to start over or choose to end, by calling the main program as a method
// further enhancements will include a score tracking system when screen is cleared and game restarted
    ...
    class GuessingGame
    {
        static void Main(string[] args)
        {
            ...
            void playGame()
            {
                ...
                Console.Write("How many guesses will you give " + player2 + "? ");
                ...
                Console.WriteLine();
                Console.WriteLine("Thank you. When ready instruct " + player2 + " to turn around and face the screen");
                Console.WriteLine("You can give " + player2 + " as many hints as you need.");
